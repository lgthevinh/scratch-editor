...
ScratchMsgs.locales['en'] = {
  ...
  EVENT_WHENARDUINOBEGIN: 'when Arduino starts',
  EVENT_WHENARDUINOLOOP: 'Arduino loop',
  ...
  OPERATORS_TONUMBER: 'to number %1',
  OPERATORS_TOTEXT: 'to text %1',
...
ScratchMsgs.locales['vi'] = {
  ...
  EVENT_WHENARDUINOBEGIN: 'khi Arduino khởi động',
  EVENT_WHENARDUINOLOOP: 'vòng lặp Arduino',
  ...
  OPERATORS_TONUMBER: 'thành số %1',
  OPERATORS_TOTEXT: 'thành chữ %1',
